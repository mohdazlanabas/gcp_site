...
└── frontend/         # Frontend files (copied from src/frontend/)
    ├── index.html
    ├── scripts.js
    └── styles.css
```
...
3. **Artifact Registry requires proper setup** - When gcr.io has been deprecated:
...
Application deployed to: https://net1io-web-475001.et.r.appspot.com

- Frontend: Accessible at root URL (`/`)
- API: Accessible at `/api/hello`
